...
const CrudModal = ({ data }) => {
  ...
  return (
    <div>
      ...
      <button
        onClick={toggleModal}
        className="mx-auto block rounded-lg bg-blue-700 px-3 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:px-5"
        type="button"
      >
        Edit
      </button>
